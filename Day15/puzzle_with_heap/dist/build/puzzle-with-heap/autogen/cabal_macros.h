...
/* package puzzle-with-heap-0.1.0.0 */
#ifndef VERSION_puzzle_with_heap
#define VERSION_puzzle_with_heap "0.1.0.0"
#endif /* VERSION_puzzle_with_heap */
#ifndef MIN_VERSION_puzzle_with_heap
#define MIN_VERSION_puzzle_with_heap(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_puzzle_with_heap */
...
#define CURRENT_COMPONENT_ID "puzzle-with-heap-0.1.0.0-AO1WWpM6ysBKwySz4capAK-puzzle-with-heap"
